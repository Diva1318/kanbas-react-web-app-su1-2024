...
<p>his is the second paragraph. Even though there is a deliberate white
...
<div id="wd-forms">
  ...
  <form id="wd-text-fields">
    ...
    <input id="wd-text-fields-username" placeholder="David" /> <br />
    <label htmlFor="wd-text-fields-password">Password:</label>
    <input type="password" id="wd-text-fields-password" value="gugvugdu" />
    <br />
    <label htmlFor="wd-text-fields-first-name">First name:</label>
    <input type="text" id="wd-text-fields-first-name" title="John" value="Roger"/> <br />
    <label htmlFor="wd-text-fields-last-name">Last name:</label>
    <input type="text" id="wd-text-fields-last-name" placeholder="Doe"
      value="Waters" title="The last name" />
...
<button id="wd-all-good" onClick={() => alert("Hahhahahahah")} type="button">
  Hello World!
</button>
{/*-----------file upload-----------------*/}
<h5>File upload</h5>
...
{/*------checkbox--------*/}
<div><h5 id="wd-checkboxes">Checkboxes</h5>
...
<div><h4>Other HTML field types</h4>
